...
<div class="container-xl shadow-lg p-3 bg-body-tertiary rounded">
	<div class="table-responsive d-flex flex-column ">
	<div class="d-flex justify-content-center">
    <h2>INNOVATION.TECH TRAINING PHP <b>CRUD</b></h2>
    </div>
        <?php 
